...
urlpatterns = patterns('',
    ...
    url(r'^lists/(?P<list_id>\d+)/items/new$', 'todo.views.item_new'),
    url(r'^lists/(?P<list_id>\d+)/items/(?P<item_id>\d+)/edit$', 'todo.views.item_edit'),
    url(r'^lists/(?P<list_id>\d+)/items/(?P<item_id>\d+)/delete$', 'todo.views.item_delete'),
